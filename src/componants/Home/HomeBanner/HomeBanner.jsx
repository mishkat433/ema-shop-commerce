...
const HomeBanner = () => {
    return (
        <div className='flex flex-col-reverse md:flex-row justify-between items-center lg:h-[80vh]'>
            ...
            <div className=' lg:mr-20'>
                <img className='w-11/12 md:w-4/5 lg:w-full ' src={thumbnails} alt="shows" />
            </div>
        </div>
    );
};
